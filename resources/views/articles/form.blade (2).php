...
@section('content')
    ...
    <div class="container mx-auto">
        ...
        <form action="{{ $article->exists ? route('articles.update', $article) : route('articles.store') }}" method="post" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="grid grid-cols-6 gap-6">
                        ...
                        <div class="col-span-6">
                            ...
                            <input name="title" type="text"
                                   class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 @error('title') border-red-300 @enderror rounded-md"
                            ...
                            <input name="thumbnail" type="file"
                                   class="@error('thumbnail') border-red-500 @enderror"
                                   value="{{ old('thumbnail', $article) }}"
                            >
                            @error('thumbnail')
                            <div class="text-red-500 mt-2">{{ $message }}</div>
                            @enderror
                            ...
                            <select name="user_id" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm rounded-md">
